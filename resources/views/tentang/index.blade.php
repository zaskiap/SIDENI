...
<head>
    ...
    <style>
        ...
        @keyframes pulse-core { 0%,100%{r:38} 50%{r:42} }
        @keyframes spike-glow { 0%,100%{opacity:0.7} 50%{opacity:1} }
        .ring1-anim { animation: spin-slow 18s linear infinite; transform-origin: 90px 90px; }
        .spike-anim { animation: spike-glow 2.5s ease-in-out infinite; }
        .spike-anim:nth-child(2n){animation-delay:0.4s}
        .spike-anim:nth-child(3n){animation-delay:0.8s}
        .core-anim { animation: pulse-core 3s ease-in-out infinite; }
    </style>
    @livewireStyles
</head>
            ...
            <div class="tentang-content">
                ...
                <div class="tentang-logo-wrap">
                    <svg width="220" height="220" viewBox="0 0 180 180" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g class="spike-anim"><line x1="90" y1="90" x2="90" y2="30" stroke="#8b0000" stroke-width="2.5" stroke-linecap="round" opacity="0.7"/><circle cx="90" cy="27" r="6" fill="#8b0000" opacity="0.85"/></g>
                        <g class="spike-anim"><line x1="90" y1="90" x2="148" y2="52" stroke="#8b0000" stroke-width="2.5" stroke-linecap="round" opacity="0.7"/><circle cx="151" cy="50" r="6" fill="#8b0000" opacity="0.85"/></g>
                        <g class="spike-anim"><line x1="90" y1="90" x2="148" y2="128" stroke="#8b0000" stroke-width="2.5" stroke-linecap="round" opacity="0.7"/><circle cx="151" cy="130" r="6" fill="#8b0000" opacity="0.85"/></g>
                        <g class="spike-anim"><line x1="90" y1="90" x2="90" y2="150" stroke="#8b0000" stroke-width="2.5" stroke-linecap="round" opacity="0.7"/><circle cx="90" cy="153" r="6" fill="#8b0000" opacity="0.85"/></g>
                        <g class="spike-anim"><line x1="90" y1="90" x2="32" y2="128" stroke="#8b0000" stroke-width="2.5" stroke-linecap="round" opacity="0.7"/><circle cx="29" cy="130" r="6" fill="#8b0000" opacity="0.85"/></g>
                        <g class="spike-anim"><line x1="90" y1="90" x2="32" y2="52" stroke="#8b0000" stroke-width="2.5" stroke-linecap="round" opacity="0.7"/><circle cx="29" cy="50" r="6" fill="#8b0000" opacity="0.85"/></g>
                        <g class="spike-anim" style="animation-delay:.6s"><line x1="90" y1="90" x2="122" y2="36" stroke="#8b0000" stroke-width="1.8" stroke-linecap="round" opacity="0.5"/><circle cx="124" cy="33" r="4.5" fill="#8b0000" opacity="0.6"/></g>
                        <g class="spike-anim" style="animation-delay:1s"><line x1="90" y1="90" x2="156" y2="82" stroke="#8b0000" stroke-width="1.8" stroke-linecap="round" opacity="0.5"/><circle cx="159" cy="82" r="4.5" fill="#8b0000" opacity="0.6"/></g>
                        <g class="spike-anim" style="animation-delay:1.4s"><line x1="90" y1="90" x2="58" y2="36" stroke="#8b0000" stroke-width="1.8" stroke-linecap="round" opacity="0.5"/><circle cx="56" cy="33" r="4.5" fill="#8b0000" opacity="0.6"/></g>
                        <g class="spike-anim" style="animation-delay:1.8s"><line x1="90" y1="90" x2="24" y2="82" stroke="#8b0000" stroke-width="1.8" stroke-linecap="round" opacity="0.5"/><circle cx="21" cy="82" r="4.5" fill="#8b0000" opacity="0.6"/></g>
                        <g class="spike-anim" style="animation-delay:.3s"><line x1="90" y1="90" x2="24" y2="108" stroke="#8b0000" stroke-width="1.8" stroke-linecap="round" opacity="0.5"/><circle cx="21" cy="109" r="4.5" fill="#8b0000" opacity="0.6"/></g>
                        <g class="spike-anim" style="animation-delay:.9s"><line x1="90" y1="90" x2="156" y2="108" stroke="#8b0000" stroke-width="1.8" stroke-linecap="round" opacity="0.5"/><circle cx="159" cy="109" r="4.5" fill="#8b0000" opacity="0.6"/></g>
